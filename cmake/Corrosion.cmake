...
function(_corrosion_add_library_target)
    ...
    if("dylib" IN_LIST CALT_LIB_KINDS)
        set(has_dylib TRUE)
    endif()

    if(NOT (has_staticlib OR has_cdylib OR has_dylib))
...
function(_add_cargo_build out_cargo_build_out_dir)
    ...
    elseif("staticlib" IN_LIST target_kinds OR "cdylib" IN_LIST target_kinds OR "dylib" IN_LIST target_kinds)
